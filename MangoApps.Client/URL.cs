namespace MangoApps.Client
{
    public static class URL
    {
        ...
        public static string DeleteGroup = "/api/groups/{group_id}";
        ...
        public static string DeleteProject = "/api/project/{project_id}";
        ...
        public static string Feed = "/api/feeds/{feed_id}";
